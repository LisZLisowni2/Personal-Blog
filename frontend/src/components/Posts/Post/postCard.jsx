...
const PostCard = request => {
    ...
    const handleDeletePost = async () => {
        await axios.delete(`http://127.0.0.1:3000/delete/${request.id}`, {
        ...
        <div className="border-2 border-black p-4 m-4 max-h-52 overflow-hidden">
            ...
            { (user && user.scope === "admin") && (
                <div className="flex flex-row">
                    ...
                    <button onClick={handleDeletePost}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
